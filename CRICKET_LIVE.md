...
- **টুর্নামেন্ট সেটআপ** (ক্লাব পিন লগইন) — টুর্নামেন্ট details (নাম, বর্ণনা, ভেন্যু, তারিখ), **match fixtures** যোগ/এডিট/মুছুন, একসাথে একাধিক fixture
- **ম্যাচ শেষ** — জয়/পরাজয় সহ **ম্যাচ সারাংশ popup** + প্রিন্ট
