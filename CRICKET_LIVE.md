...
- **টিম লিস্ট / প্রিন্ট** — ম্যাচের আগে ১১ জন + রোল (Batter/Bowler/Allrounder/WK)
- **স্ট্রিম গ্রাফিক্স** — Batting XI (রোলসহ), Bowling (listed + part-time), যেকোনো প্লেয়ার
- ক্রিকেট রুলস: ওভার শেষে স্ট্রাইক চেঞ্জ, উইকেটে নতুন ব্যাটার
