        ...
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <p className="text-2xl font-semibold text-[#8f624e]">{formatBdt(product.price)}</p>
              {product.compareAtPrice ? (
                <p className="text-sm text-[#a0897d] line-through">{formatBdt(product.compareAtPrice)}</p>
              ) : null}
            </div>
