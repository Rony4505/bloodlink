...
export const dictionaries = {
  en: {
    ...
    donationBadgeHelper: "Helping hand",
    donationBadgeLifesaver: "Life saver",
    donationBadgeHero: "Hero donor",
    donationBadgeLegend: "Legend",
    donationCountHint:
    ...
    otpRegisterNotice:
      "For your safety, BloodLink creates the account only after Gmail and mobile OTP verification.",
    otpSendCodes: "Send verification codes",
    otpVerifyTitle: "Verify Gmail & mobile",
    otpVerifyBody:
      "Enter the codes sent to {email} and {phone}. Your donor account is created only after both are verified.",
    otpEmailCode: "Gmail OTP",
    otpPhoneCode: "Mobile OTP",
    otpConfirmCreate: "Verify & create account",
    otpResend: "Resend codes",
    otpResent: "New codes sent.",
  ...
  bn: {
    ...
    donationBadgeHelper: "সহায়ক হাত",
    donationBadgeLifesaver: "জীবনরক্ষক",
    donationBadgeHero: "হিরো ডোনার",
    donationBadgeLegend: "কিংবদন্তি",
    donationCountHint:
    ...
    otpRegisterNotice:
      "নিরাপত্তার জন্য Gmail ও মোবাইল OTP যাচাইয়ের পরই BloodLink অ্যাকাউন্ট তৈরি হবে।",
    otpSendCodes: "ভেরিফিকেশন কোড পাঠান",
    otpVerifyTitle: "Gmail ও মোবাইল যাচাই",
    otpVerifyBody:
      "{email} ও {phone}-এ পাঠানো কোড দিন। দুটোই সঠিক হলেই ডোনার অ্যাকাউন্ট তৈরি হবে।",
    otpEmailCode: "Gmail OTP",
