...
export const dictionaries = {
  en: {
    ...
    adminContactLogHint:
      "Who revealed whose number — seeker details are kept for future investigation.",
    noContactLogs: "No contact reveals logged yet.",
    contactKindDonor: "Donor number revealed",
    contactKindPost: "Blood-post number unlocked",
  ...
  bn: {
    ...
    adminContactLogHint:
      "কে কার নম্বর দেখেছে — ভবিষ্যৎ তদন্তের জন্য যোগাযোগকারীর তথ্য সংরক্ষিত থাকে।",
    noContactLogs: "এখনো কোনো যোগাযোগ লগ নেই।",
    contactKindDonor: "ডোনার নম্বর দেখা হয়েছে",
    contactKindPost: "ব্লাড-পোস্ট নম্বর আনলক",
