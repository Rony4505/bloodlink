...
export const dictionaries = {
  en: {
    ...
    volunteerCredHint:
      "Volunteer can log in at /volunteer/login — only update their assigned work and browse the public site.",
    volunteerNoLogin: "No login set",
    volunteerResetPassword: "Reset password",
  ...
  bn: {
    ...
    volunteerCredHint:
      "ভলান্টিয়ার /volunteer/login দিয়ে লগইন করতে পারবে — শুধু তাদের অ্যাসাইন করা কাজ আপডেট ও পাবলিক সাইট দেখা।",
    volunteerNoLogin: "লগইন সেট নেই",
    volunteerResetPassword: "পাসওয়ার্ড রিসেট",
